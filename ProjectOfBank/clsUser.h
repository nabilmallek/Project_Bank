...
public:
	...
	enum enPermissions {eAll = -1 , pListClients = 1 , pAddNewClients = 2 , pDeleteClients = 4 , pUpdateClients = 8,
	pFindClients = 16 , pTransactions = 32,pManagerUsers = 64, pLoginRegister = 128};
	 ...
	 bool  CheckAccessPermission(enPermissions Permissions)
	{
	 ...
	 void RegisterLogin()
	 {
		 string DataLine = _PreperLoginRecord();
		 fstream MyFile;
		 MyFile.open("RegesterLogin.txt", ios::out | ios::app);
	...
	static vector <stLoginRegisterRecord> GetLoginRegisterList()
	 {
		 ...
		 fstream MyFile;
		 MyFile.open("RegesterLogin.txt", ios::in);
		 if (MyFile.is_open())
		 {
			 string Line;
			 stLoginRegisterRecord  LoginRegisterRecord;
